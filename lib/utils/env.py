...
_TORCH_INSTALL_PREFIX = '/usr/local/lib/python3.7/dist-packages/torch/'
...
def get_detectron_ops_lib():
    ...
    prefixes = [_CMAKE_INSTALL_PREFIX, _TORCH_INSTALL_PREFIX, sys.prefix, sys.exec_prefix] + sys.path
